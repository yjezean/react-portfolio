  ...
  description: (
    <>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        I'm a student pursuing for a{" "}
        <strong className="text-stone-100">
          Bachelor of Computer Sciences
        </strong>
        , at{" "}
        <strong className="text-stone-100">Universiti Sains Malaysia</strong>.
      </p>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        THis website serves as a brief introduction of myself. To know me more,
        feel free to contact me via any available channels.
      </p>
    </>
  ),
  actions: [
...
export const aboutData: About = {
  ...
  description:
    "As a student in Bachelor of Computer Sciences in Universiti Sains Malaysia,I have a great passion to explore job fields related to latest technologies and always passionate to explore every possibility. Take it easy and keep it easy.",
  aboutItems: [
...
export const education: TimelineItem[] = [
  {
    ...
    content: (
      <p>
        Pursuing for Degree in COmputer Sciences majoring in Intelligence
        Computing. Graduating in October 2026.
      </p>
    ),
  },
  {
    ...
    title: "Matrikulasi",
    content: (
      <p>Taking matriculation programme in Module 1. With GPA of 4.0. </p>
    ),
  },
  {
    date: "2015 - 2020",
...
export const experience: TimelineItem[] = [
  ...
  },
  {
    ...
    location:
      "Core team member of Event Planning & Culture Development Department",
    title: "",
    content: <p></p>,
  },
  {
  ...
  testimonials: [
    {
      name: "Ezean",
      text:
        "As a human, just enjoy the life with the simplest mindset. Do not waste time for unhappiness. Take it easy.",
      image:
        "https://mondaymandala.com/wp-content/uploads/Printable-Winking-Face-Emoji_-791x1024.jpg",
    },
  ],
};
...
export const contact: ContactSection = {
  ...
  description:
    "Do not hesitate to approach me if you want to know more about me. ",
  items: [
    {
...
export const socialLinks: Social[] = [
  { label: "Github", Icon: GithubIcon, href: "https://github.com/yjezean" },
  {
    label: "LinkedIn",
    Icon: LinkedInIcon,
    href: "https://www.linkedin.com/in/yi-jian-chong-587653255/",
  },
  {
    label: "Instagram",
    Icon: InstagramIcon,
